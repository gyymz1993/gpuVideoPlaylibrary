...
public class PictureSelectionModel {
     ...
     * @return
     */
    public PictureSelectionModel setOnSelcterVideoFilter(PictureSelectionConfig.OnSelectClickListner onSelectClickListner) {
        selectionConfig.setOnSelectClickListner(onSelectClickListner);
        return this;
    }
