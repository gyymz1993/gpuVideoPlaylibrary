...
/*                    if (!mScroller.isFinished()) {
    ...
    public interface OnSmoothExpandStausListener {
        void isExpand(boolean isExpand);
    }


    OnSmoothExpandStausListener onSmoothExpandStaus;

    public OnSmoothExpandStausListener getOnSmoothExpandStaus() {
        return onSmoothExpandStaus;
    }

    public void setOnSmoothExpandStaus(OnSmoothExpandStausListener onSmoothExpandStaus) {
        this.onSmoothExpandStaus = onSmoothExpandStaus;
    }
    ...
    public void smoothExpand() {
        ...
        if (onSmoothExpandStaus != null) {
            onSmoothExpandStaus.isExpand(true);
        }
    }
...
/*        mScroller.startScroll(getScrollX(), 0, -getScrollX(), 0);
        ...
        if (onSmoothExpandStaus != null) {
            onSmoothExpandStaus.isExpand(false);
        }
