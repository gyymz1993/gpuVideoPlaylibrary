...
public class GPUImageFilterTools {
    ...
    public static FilterList getFilterList() {
        ...
        *
        * */
        filters.addFilter("原画", FilterType.NOFILTER);
        filters.addFilter("泛黄记忆", FilterType.TEST_2);
        filters.addFilter("青涩年华", FilterType.TEST_3);
        filters.addFilter("日系", FilterType.TEST_4);
        filters.addFilter("老照片", FilterType.TEST_5);
        filters.addFilter("暮光之城", FilterType.TEST_6);
        filters.addFilter("一期一会", FilterType.TEST_7);
        filters.addFilter("云中漫步", FilterType.TEST_8);
        return filters;
    }


    public static GPUImageFilter createFilterForUser(final FilterType type) {
        switch (type) {

            case NOFILTER:
                return new GPUImageFilter();
            case TEST_2:
                return new GPUImageRGBFilter(1.0f, 1.0f, 222 / 255);
            case TEST_3:
                return new GPUImageRGBFilter(211 / 255, 1.0f, 229 / 255);
            case TEST_4:
                return new GPUImageRGBFilter(233 / 255, 1.0f, 207 / 255);
            case TEST_5:
                return new GPUImageRGBFilter(1.0f, 1.0f, 207 / 255);
            case TEST_6:
                return new GPUImageRGBFilter(1.0f, 228 / 255, 165 / 255);
            case TEST_7:
                return new GPUImageRGBFilter(1.0f, 1.0f, 222 / 255);
            case TEST_8:
                return new GPUImageRGBFilter(203 / 255, 1.0f, 253 / 255);
            default:
                //return new GPUImageRGBFilter(1.0f, 0, 0);
                throw new IllegalStateException("No filter of that type!");
        }

    }

    public static int getFilterBitmap(final FilterType type) {
        switch (type) {
            case NOFILTER:
                return R.drawable.filter_no;
            case TEST_2:
                return R.drawable.filter_fanhuang;
            case TEST_3:
                return R.drawable.filter_qs;
            case TEST_4:
                return R.drawable.filter_rx;
            case TEST_5:
                return R.drawable.filter_old;
            case TEST_6:
                return R.drawable.filter_mg;
            case TEST_7:
                return R.drawable.filter_yqyh;
            case TEST_8:
                return R.drawable.filter_yzmb;
            default:
                throw new IllegalStateException("No filter of that type!");
        }
    ...
    public static int getTurnBitmap(final int positon) {
        switch (positon) {
            case 0:
                return R.drawable.turn_no;
            case 1:
                return R.drawable.turn_hb;
            case 2:
                return R.drawable.trun_hp;
            case 3:
                return R.drawable.turn_black;
            case 4:
                return R.drawable.trun_circle;
            case 5:
                return R.drawable.turn_rj;
            default:
                throw new IllegalStateException("No filter of that type!");
        }
...
//                        context.getResources().openRawResource(R.raw.tone_cuver_sample));
            ...
            case LOOKUP_AMATORKA:
                ...
                amatorka.setBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_launcher));
                return amatorka;
            case GAUSSIAN_BLUR:
    ...
    public enum FilterType {
        ...
        SPHERE_REFRACTION, SWIRL, WEAK_PIXEL_INCLUSION, FALSE_COLOR, COLOR_BALANCE, LEVELS_FILTER_MIN, BILATERAL_BLUR, HALFTONE, TRANSFORM2D, BURN_TEXT, TEST_1, TEST_2, TEST_3, TEST_4, TEST_5, TEST_6, TEST_7, TEST_8
    }
